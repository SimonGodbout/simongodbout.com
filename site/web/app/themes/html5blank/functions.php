...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/assets/dist/js/app.js', array(''), '1.0.0'); // Custom scripts
...
{
    wp_register_style('googleFonts', 'https://fonts.googleapis.com/css?family=Permanent+Marker|Play|Righteous', array(), '1.0', 'all');
